...
#clean categories for graphing, get top 6
categories <- c()
...
#rename categories and trim dataset based on median game playtime and post 2010
...
#Plot average rating by category and playtime
...
plot <- subset %>%
  ...
  geom_label_repel(aes(label=name), family = "Cabin", size = 3, max.overlaps = 30)+
